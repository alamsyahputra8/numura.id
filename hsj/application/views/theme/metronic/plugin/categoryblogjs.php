...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>core/modalcategoryblog',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $('#namedata').html(data.category);
        $('#ed_id').val(data.id);
        $('#ed_name_cat_id').val(data.category);
		$('#ed_name_cat_en').val(data.category_en); 
        $('#ed_deskripsi_id').summernote('code', data.deskripsi);
		$('#ed_deskripsi_en').summernote('code', data.deskripsi_en);
...
var KTDatatablesSearchOptionsColumnSearch = function() {
	...
	var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            ajax: {
                url: '<?PHP echo base_url(); ?>core/getdatacategory',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'category', 'description', 'updateby', 'lastupdate', 'actions',],
                },
            },
			columns: [
                {data: 'category'},
...
var KTFormWidgets = function () {
    ...
    var initInsert = function () {
    	$('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/insertcategoryblog",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/updatecategoryblog",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
    	$('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>core/deletecategoryblog",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
