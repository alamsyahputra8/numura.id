            ...
            if ( KTUtil.isInResponsiveRange('desktop') ) {
                ...
                if ( KTUtil.isset(the.options.submenu, 'desktop.state.body') ) {
                    if ( KTUtil.hasClasses(body, the.options.submenu.desktop.state.body) ) {
                        ret‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          n the.options.submenu.desktop.default;
                    }
...
var KTPortlet = function(elementId, options) {
    ...
    ‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU              }
    ...
    return {
        ...
        init: function(options) {
            if (options && options.breakpoints) {
                breakpoi‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          /**
        ...
        triggerEvent: function(node, eventName) {
            ...
            if (node.dispatchEvent) {
                ...
                event.synthetic = true; // allow detection of synthetic events
                ‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU                      elm = KTUtil.get(elm);
	...
	$.fn[pluginName] = function(options) {
		...
		var Plugin = {
			...
			extractTable: function() {
				...
				// auto‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          
				...
				$(tablePart).find('.' + pfx + 'datatable__row').each(function(tri, tr) {
					...
					if (typeof obj === 'undefined') {
						...
						$(tr).find('.' + pfx + 'datatable__cell').each(function(tdi, td) {
							...
							if (typeof column !== 'undefine‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          + pfx + 'datatable__cell').each(function(tdi, td) {
						// get column settings by field
						var column = $.grep(columns, function(n, i) {
							return $(td).data('field') === n.field;
						})[0];
					...
					if (options.pagination) {
						if (options.data.serverPaging && options.data.type !== 'local') {
							...
							if (serverMeta !== null) {
								...
								// ‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          paging(buildMeta(), localPagingCallback);
							}
						} else {
			...
			paging: function(meta, callback) {
				var pg = {
					...
					updatePerpage: function(e) {
						...
						// update page callback function
‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          g.paginateEvent, pg.meta);
						pg.callback(pg, pg.meta);
					...
					switch (type) {
						...
						case 'number':
							...
							if (sort === 'asc') {
								...
								return aField < b‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          ta).sort(function(a, b) {
			...
			localDataUpdate: function() {
				...
				if (typeof params.query === 'object' && !Plugin.getOption('data.serverFiltering')) {
					...
					if (typeof sear‡ﬂªU  ‡ﬂªU                  êﬁªU          †2ÊªU  HﬂªU           ﬂªU   @       ﬂªU          $.grep(datatable.dataSet, nestedSearch);
