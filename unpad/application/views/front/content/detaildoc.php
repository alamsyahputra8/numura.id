                ...
                <div class="row">
                    ...
                    <div class="content col-lg-12">
                    	<div class="row team-members team-members-left team-members-shadow m-b-40">
		                    ...
		                    ?>
		                    <div class="col-lg-6">
		                    	<a href="<?PHP echo base_url(); ?>images/document/<?PHP if(get_cookie('lang_is') === 'en'){ echo $data['file_doc_en']; } else { echo $data['file_doc']; } ?>" target="_blank" data-toggle="tooltip" data-placement="top" title="" data-original-title="View File <?PHP if(get_cookie('lang_is') === 'en'){ echo $data['name_doc_en']; } else { echo $data['name_doc']; } ?>">
			                        <div class="team-member">
			                            <div class="team-image">
			                                <center><img src="<?PHP echo base_url(); ?>images/icon/docicon.png"></center>
			                            </div>
			                            <div class="team-desc bolddesc">
			                                <h3><?PHP if(get_cookie('lang_is') === 'en'){ echo $data['name_doc_en']; } else { echo $data['name_doc']; } ?></h3>
