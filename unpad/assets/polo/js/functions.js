...
(function ($) {
    ...
    INSPIRO.widgets = {
        ...
        downloadForm: function () {
            ...
            var $downloadForm = $(".widget-download-form");
            ...
            if ($downloadForm.length > 0) {
                ...
                $downloadForm.each(function () {
                    var elem = $(this),
                        elemSuccessMessage = elem.attr('data-success-message') || "Link download sudah dikirim ke email Anda.";
