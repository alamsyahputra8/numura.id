...
<?PHP $this->load->view('theme/polo/plugin1'); ?>
        ...
        <!-- Inspiro Slider -->
        <div id="slider" class="inspiro-slider slider-fullscreen arrows-small arrows-creative dots-creative" data-height="360" data-height-xs="360">
            <?PHP
            $qSlides    = "select * from banner where flag_website='3' order by 1 desc";
        ...
        <style>
            #slider { background-color: #1e1e1e; }
            /*.inspiro-slider .slide { opacity: 0.3; }*/
            .linkbanner {
                width: 100%;
                height: 100%;
