...
<header id="header" data-fullwidth="true" data-transparent="true" class="dark submenu-light">
    <div class="header-inner">
        <div class="container"> <!--Logo-->
            <div id="logo">
                <a href="<?PHP echo base_url(); ?>../" class="logo" data-src-dark="<?PHP echo base_url(); ?>../images/unpad-peternakan_w.png">
                    <img src="<?PHP echo base_url(); ?>../images/unpad-peternakan_w.png" alt="<?PHP echo $site['name_site']; ?>">
                </a>
            </div>
            <!--End: Logo-->
            ...
            <!-- Search -->
            <div id="search">
                <div id="search-logo"><img src="<?PHP echo base_url(); ?>../images/unpad-peternakan_w.png" alt="<?PHP echo $site['name_site']; ?>"></div>
                ...
                <div class="container">
                    ...
                    ?>
                     <nav>
                        <ul>
                            ...
                            <?PHP
                            $qMenu      = "select * from menu_site where parent='0' and flag_website='3' order by sort asc";
                            ...
                            foreach ($getMenu as $datamenu) {
                                ...
                                if ($datamenu['link']=='#' or $datamenu['link']=='' or $datamenu['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                            ?>
                            <li <?PHP echo $classChild; ?>>
                                <a href="<?PHP echo $page; ?><?PHP echo $datamenu['link']; ?>"><?PHP echo $datamenu['menu_en']; ?></a>
                                <?PHP if ($cekChild>0) { ?>
                                    <ul class="dropdown-menu">
                                        ...
                                        foreach ($getChild as $datachild) {
                                            ...
                                            if ($datachild['link']=='#' or $datachild['link']=='' or $datachild['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                        ?>
                                        <li <?PHP echo $classChild2; ?>><a href="<?PHP echo $page; ?><?PHP echo $datachild['link']; ?>"><?PHP echo $datachild['menu_en']; ?></a>
                                            <?PHP if ($cekChild2>0) { ?>
                                            <ul class="dropdown-menu">
                                                <?PHP
                                                ...
                                                foreach ($getChild2 as $datachild2) {
                                                    ...
                                                    if ($datachild2['link']=='#' or $datachild2['link']=='' or $datachild2['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                                ?>
                                                <li <?PHP echo $classChild3; ?>><a href="<?PHP echo $page; ?><?PHP echo $datachild2['link']; ?>"><?PHP echo $datachild2['menu_en']; ?></a>
                                                    <?PHP if ($cekChild3>0) { ?>
                                                    <ul class="dropdown-menu">
                                                        <?PHP
                                                        ...
                                                        foreach ($getChild3 as $datachild3) {
                                                            ...
                                                            if ($datachild3['link']=='#' or $datachild3['link']=='' or $datachild3['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                                        ?>
                                                        <li><a href="<?PHP echo $page; ?><?PHP echo $datachild3['link']; ?>"><?PHP echo $datachild3['menu_en']; ?></a></li>
                                                        <?PHP } ?>
                                                    </ul>
                                                    <?PHP } ?>
                                                </li>
                    ...
                    <nav>
                        <ul>
                            ...
                            ?>
                            <li <?PHP echo $classChild; ?>>
                                <a href="<?PHP echo $page; ?><?PHP echo $datamenu['link']; ?>"><?PHP echo $datamenu['menu']; ?></a>
                                <?PHP if ($cekChild>0) { ?>
                                    <ul class="dropdown-menu">
                                        <?PHP
                                        $qChild     = "select * from menu_site where parent='$idmenu' order by sort asc";
                                        ...
                                        foreach ($getChild as $datachild) {
                                            ...
                                            if ($datachild['link']=='#' or $datachild['link']=='' or $datachild['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                        ?>
                                        <li <?PHP echo $classChild2; ?>><a href="<?PHP echo $page; ?><?PHP echo $datachild['link']; ?>"><?PHP echo $datachild['menu']; ?></a>
                                            <?PHP if ($cekChild2>0) { ?>
                                            <ul class="dropdown-menu">
                                                <?PHP
                                                $qChild2     = "select * from menu_site where parent='$idmenuC' order by sort asc";
                                                ...
                                                foreach ($getChild2 as $datachild2) {
                                                    ...
                                                    if ($datachild2['link']=='#' or $datachild2['link']=='' or $datachild2['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                                ?>
                                                <li <?PHP echo $classChild3; ?>><a href="<?PHP echo $page; ?><?PHP echo $datachild2['link']; ?>"><?PHP echo $datachild2['menu']; ?></a>
                                                    <?PHP if ($cekChild3>0) { ?>
                                                    <ul class="dropdown-menu">
                                                        <?PHP
                                                        $qChild3     = "select * from menu_site where parent='$idmenuC2' order by sort asc";
                                                        ...
                                                        foreach ($getChild3 as $datachild3) {
                                                            ...
                                                            if ($datachild3['link']=='#' or $datachild3['link']=='' or $datachild3['style']=='link') { $page   = ''; } else { $page   = base_url().'page/'; }
                                                        ?>
                                                        <li><a href="<?PHP echo $page; ?><?PHP echo $datachild3['link']; ?>"><?PHP echo $datachild3['menu']; ?></a></li>
                                                        <?PHP } ?>
                                                    </ul>
                                                    <?PHP } ?>
                                                </li>
