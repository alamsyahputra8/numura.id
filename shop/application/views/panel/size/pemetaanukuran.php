			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions text-right">
						...
						<?PHP echo getRoleInsert($akses,'addnewfac','Buat Pemetaan Baru');?>
					</div>
				</div>
			</div>
		</div>
					...
					<form class="kt-form kt-form--label-right" id="forminsert" enctype="multipart/form-data" method="POST">
						<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
							<div class="kt-portlet__head">
								<div class="kt-portlet__head-label">
									<h3 class="kt-portlet__head-title">Buat Pemetaan</h3>
								</div>
								<div class="kt-portlet__head-toolbar">
								</div>
							</div>
							<div class="kt-portlet__body">
								<div class="form-group row">
									<label class="col-form-label col-lg-2 col-sm-12">Ukuran</label>
									<div class="col-lg-10 col-sm-12">
										<div class='input-group'>
											<select name="size" class="form-control" id="size" placeholder="Ukuran">
								...
								<div class="form-group row">
									<label class="col-form-label col-lg-2 col-sm-12">Warna</label>
									<div class="col-lg-10 col-sm-12">
										<div class='input-group'>
											<select name="warna" class="form-control" id="warna" placeholder="Warna">
												<option value="">Pilih...</option>
												<?PHP foreach ($getColor as $col) { ?>
													<option value="<?PHP echo $col['id']; ?>"><?PHP echo $col['label']; ?></option>
												<?PHP } ?>
											</select>
										</div>
									</div>
								...
								<div class="form-group row">
									<label for="role" class="col-lg-2 col-sm-12 col-form-label">SKU Shopee</label>
									<div class="col-lg-10 col-sm-12">
										<div class='input-group'>
											<div class='input-group'>
						...
						<div class="modal-footer">
							...
							<button type="submit" id="saveandcreate" class="btn btn-primary">Simpan & Buat Pemetaan Baru</button>
							...
							<div class="modal-body kt-portlet kt-portlet--tabs" style="margin-bottom: 0px;">
								...
								<div class="kt-portlet__body">
									...
									<div class="form-group row">
										...
										<div class="col-lg-10 col-sm-12">
											<div class='input-group'>
												...
												<select name="ed_size" class="form-control" id="ed_size" placeholder="Ukuran">
													<option value="">Pilih...</option>
													<?PHP foreach ($getSize as $size) { ?>
														<option value="<?PHP echo $size['id_size']; ?>"><?PHP echo $size['label']; ?> <?PHP echo $size['detail']; ?></option>
													<?PHP } ?>
									...
									<div class="form-group row">
										...
										<div class="col-lg-10 col-sm-12">
											<div class='input-group'>
												<select name="ed_warna" class="form-control" id="ed_warna" placeholder="Warna">
													<option value="">Pilih...</option>
													<?PHP foreach ($getColor as $col) { ?>
														<option value="<?PHP echo $col['id']; ?>"><?PHP echo $col['label']; ?></option>
													<?PHP } ?>
									...
									<div class="form-group row">
										...
										<div class="col-lg-10 col-sm-12">
											<div class='input-group'>
												<div class='input-group'>
													<input type="text" name="ed_sku" class="form-control" id="ed_sku" placeholder="SKU">
												</div>
											</div>
										</div>
									</div>
