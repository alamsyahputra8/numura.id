...
$(document).on('keyup', '.pcsval', function(e){
    ...
    form.ajaxSubmit({
        url: "<?PHP echo base_url(); ?>stok/cektotal",
        type: "POST",
        dataType: 'json',
        beforeSend: function(){ 
...
$(document).on('keyup', '.ed_pcsval', function(e){
    ...
    form.ajaxSubmit({
        url: "<?PHP echo base_url(); ?>stok/cektotaledit",
        type: "POST",
        dataType: 'json',
        beforeSend: function(){ 
...
$(document).on('click', '.btnupdateM', function(e){
    ...
    .done(function(data){
        ...
        $.ajax({
            url: '<?PHP echo base_url(); ?>stok/getorder',
...
var KTFormWidgets = function () {
    ...
    var initWidgets = function() {
        ...
        $(".getPenanggung").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?PHP echo base_url(); ?>stok/listcustomer",
                dataType: 'json',
                delay: 250,
    ...
    var initInsert = function () {
        $('#saveinsert').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/insert",
                type: "POST",
                beforeSend: function(){ 
                   KTApp.block('#addnewfac .modal-content', {
                        overlayColor: '#000000',
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/update",
                type: "POST",
                beforeSend: function(){ 
                   KTApp.block('#update .modal-content', {
                        overlayColor: '#000000',
    ...
    var initBayar = function () {
        $('#paymentBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/payment",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initFinish = function () {
        $('#finishBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/setfinish",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
        $('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/delete",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
    ...
    var initProses = function () {
        $('#prosesBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>stok/approve",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
