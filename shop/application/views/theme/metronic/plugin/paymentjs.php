...
$(document).on('click', '.btnupdateM', function(e){
    ...
    .done(function(data){
        ...
        $("#ed_id").val(data.id_payment);
        $('#ed_user').val(data.userid);
        $('#ed_masuk').val(data.masuk);
        $('#ed_keluar').val(data.keluar);
        $('#ed_tgl').val(data.tgl_paid);
        $('#ed_type').val(data.type);
