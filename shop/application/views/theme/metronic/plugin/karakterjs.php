...
var loadDataAwal = function () {
    KTApp.block('#bgdatakar', {
        overlayColor: '#000000',
        type: 'v2',
        state: 'success',
        message: 'Please wait...'
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>karakter/getdata',
        type: 'POST',
    })
    .done(function(data){
        $('#bgdatakar').html(data);
        setTimeout(function() {
            KTApp.unblock('#bgdatakar');
        }, 2000);
    })
    .fail(function(){
        setTimeout(function() {
...
$(document).on('click', '.btnupdateM', function(e){
    ...
    $('.select2norm').val('');
    $.ajax({
        url: '<?PHP echo base_url(); ?>karakter/modal',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
    .done(function(data){
        ...
        $("#ed_id").val(data.id_karakter);
        $('#ed_b_now').val(data.sisa_bayi);
        $('#ed_a_now').val(data.sisa_anak);
...
$(document).on('click', '.btnPrint', function(e){
    ...
    $.ajax({
        url: '<?PHP echo base_url(); ?>payment/modal',
        type: 'POST',
        data: 'id='+uid,
        dataType: 'json'
    })
...
var KTDatatablesSearchOptionsColumnSearch = function() {
    ...
    var initTable1 = function() {
        ...
        var table = $('#tabledata').DataTable({
            ...
            order: [[ 3, "desc" ], [ 0, "asc" ]],
            ajax: {
                url: '<?PHP echo base_url(); ?>payment/getdata',
                type: 'POST',
                data: {
                    // parameters for custom backend script demo
                    columnsDef: [
                        'name','masuk', 'keluar','tgl','type','actions'],
                },
            },
            columns: [
...
var KTFormWidgets = function () {
    ...
    var initWidgets = function() {
        ...
        $(".getPenanggung").select2({
            ...
            allowClear: true,
            ajax: {
                url: "<?PHP echo base_url(); ?>payment/listcustomer",
                dataType: 'json',
                delay: 250,
    ...
    var initUpdate = function () {
        $('#saveupdate').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>karakter/update",
                type: "POST",
                beforeSend: function(){ 
    ...
    var initDelete = function () {
        $('#deleteBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>karakter/delete",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
    ...
    var initProses = function () {
        $('#prosesBtn').click(function(e) {
            ...
            form.ajaxSubmit({
                url: "<?PHP echo base_url(); ?>payment/approve",
                type: "POST",
                success: function(data) {
                    if(data) {
                        // similate 2s delay
