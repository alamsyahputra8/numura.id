...
$(window).bind("load", function() {
    document.title = "Detail Pengiriman | NUMURA.ID";
    $('.kt-subheader__title').html('Detail Pengiriman');
});
$(document).ready(function() {
    ...
    function getProfile(){
        var id = <?PHP echo $uid;?>;
        $.ajax({
            url: '<?PHP echo base_url(); ?>user/getProfile',
            type: 'POST',
            data: 'id='+id,
            dataType: 'json'
        })
    ...
    function getDetail(){
        ...
        $.ajax({
            url: '<?PHP echo base_url(); ?>pengiriman/getpesanandetail',
            type: 'POST',
            data: 'id='+id,
        })
        .done(function(data){
        ...
        .fail(function(){
            $('#bgdetailpesanan').html('Mohon maaf, data pesanan tidak ditemukan.');
        });
    }
});
