...
<head>
	...
	<style type="text/css">
		...
		.elementor-24224 .elementor-element.elementor-element-53053e1 .elementor-heading-title {
			font: 400 18px/20px 'Playball', cursive!important;
		    margin-top: 15px;
		    color: #3f4231;
		}
		.gla_flower2_name_l, .gla_flower2_name_r {
		...
		.elementor-24224 .elementor-element.elementor-element-53053e1 .elementor-heading-title span {
			font: 400 45px/60px 'Playball', cursive!important;
			color: #4b554b;
		}
		...
		.elementor-24224 .elementor-element.elementor-element-2467aaa .elementor-heading-title {
			font: normal 500 20px/30px 'Montserrat', sans-serif!important;
		}
		.elementor-24224 .elementor-element.elementor-element-b8a5e50 .elementor-button {
			font: normal 600 14px/16px 'Montserrat', sans-serif!important;
			margin-top: -20px;
			background: #78968C;
			color: #FFF;
			text-shadow: none;
		...
		@media (max-width: 767px) {
			...
			.gla_flower2_name_mob {
				display: block;
				font: 400 55px/60px 'Playball', cursive;
				margin-top:60px;
				color: #78968C;
			}
			...
			.elementor-24224 .elementor-element.elementor-element-53053e1 .elementor-heading-title {
				font: 400 18px/18px 'Playball', cursive!important;
				margin-top: -5px;
			}
			.elementor-24224 .elementor-element.elementor-element-53053e1 .elementor-heading-title span {
				font: 400 50px/60px 'Playball', cursive!important;
			}
		}
	</style>
