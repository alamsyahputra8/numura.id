...
$(window).bind("load", function() {
    ...
    $("#bgresult").load( "<?PHP echo base_url(); ?>resultadmin/all", function() {
        $(".loaderstat").fadeOut('slow');
    });
});
...
$("#reseller").change(function(){
    ...
    $("#bgresult").load( "<?PHP echo base_url(); ?>resultadmin/"+userid+"", function() {
        $(".loaderStatus").fadeOut('slow');
    });
});

$( "#filterall" ).click(function() {
    var pengaju = $('#kt_select2_1').val(); 
    var noreq = $('#noreq').val();
    if(noreq==''){noreq='null'}
    $("#dashboardStatus").load( "widget/dashboardStatus/"+pengaju+"/"+noreq+"/all", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardDonut").load( "widget/dashboardDonut/"+pengaju+"/"+noreq+"/all", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardAM").load( "widget/dashboardAm/"+pengaju+"/"+noreq+"/all", function() {
        $(".loaderam").fadeOut('slow');
    });

});
$( "#filterapprove" ).click(function() {
    var pengaju = $('#kt_select2_1').val(); 
    var noreq = $('#noreq').val();
    if(noreq==''){noreq='null'}
    $("#dashboardStatus").load( "widget/dashboardStatus/"+pengaju+"/"+noreq+"/approve", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardDonut").load( "widget/dashboardDonut/"+pengaju+"/"+noreq+"/approve", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardAM").load( "widget/dashboardAm/"+pengaju+"/"+noreq+"/approve", function() {
        $(".loaderam").fadeOut('slow');
    });
});
$( "#filterpending" ).click(function() {
    ...
    var noreq = $('#noreq').val();
    if(noreq==''){noreq='null'}
    $("#dashboardStatus").load( "widget/dashboardStatus/"+pengaju+"/"+noreq+"/pending", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardDonut").load( "widget/dashboardDonut/"+pengaju+"/"+noreq+"/pending", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardAM").load( "widget/dashboardAm/"+pengaju+"/"+noreq+"/pending", function() {
        $(".loaderam").fadeOut('slow');
    });
});
$( "#filterreject" ).click(function() {
    var pengaju = $('#kt_select2_1').val(); 
    var noreq = $('#noreq').val();
    if(noreq==''){noreq='null'}
    $("#dashboardStatus").load( "widget/dashboardStatus/"+pengaju+"/"+noreq+"/reject", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardDonut").load( "widget/dashboardDonut/"+pengaju+"/"+noreq+"/reject", function() {
        $(".loaderStatus").fadeOut('slow');
    });
    $("#dashboardAM").load( "widget/dashboardAm/"+pengaju+"/"+noreq+"/reject", function() {
        $(".loaderam").fadeOut('slow');
    });
});
